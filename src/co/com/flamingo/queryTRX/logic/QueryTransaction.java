...
public class QueryTransaction {
	...
	public static POSTransaction getTransactionGrouped(String tienda, String caja, String transaccion, String fecha) {
		ServiceDAO sDao = new ServiceDAO();
		tienda = String.format("%03d", Integer.parseInt(tienda));
		caja = String.format("%04d", Integer.parseInt(caja));
		transaccion = String.format("%04d", Integer.parseInt(transaccion));
		return sDao.getTransactionGrouped(tienda, caja, transaccion, fecha);
	}
