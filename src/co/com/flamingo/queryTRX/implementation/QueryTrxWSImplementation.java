...
public class QueryTrxWSImplementation implements QueryTrxWSInt {
	...
	@Override
	public POSTransaction transactionRequestGrouped(String tienda, String caja, String transaccion, String fecha) {
		return QueryTransaction.getTransactionGrouped(tienda, caja, transaccion, fecha);
	}
