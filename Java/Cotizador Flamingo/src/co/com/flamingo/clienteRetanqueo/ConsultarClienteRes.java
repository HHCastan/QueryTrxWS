 ...
 *       &lt;sequence>
 *         &lt;element name="DatosCliente" type="{http://www.flamingo.com.co}infoClienteBasica" minOccurs="0"/>
...
public class ConsultarClienteRes {
    ...
    @XmlElementRef(name = "DatosCliente", namespace = "http://www.flamingo.com.co", type = JAXBElement.class, required = false)
    protected JAXBElement<InfoClienteBasica> datosCliente;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link InfoClienteBasica }{@code >}
     *     
     */
    public JAXBElement<InfoClienteBasica> getDatosCliente() {
        return datosCliente;
    }
     ...
     *     
     */
    public void setDatosCliente(JAXBElement<InfoClienteBasica> value) {
