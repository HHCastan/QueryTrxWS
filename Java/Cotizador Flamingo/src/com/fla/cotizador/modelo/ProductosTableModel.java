...
public class ProductosTableModel implements TableModel {
	...
	public Class<?> getColumnClass(int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			// La columna cero contiene el codigo del producto, que es un String
			return String.class;
		case 1:
			// La columna uno contiene la fecha del producto, que es un String
			return String.class;
		case 2:
			// La columna dos contine el valor del producto, que es un String
			return String.class;
		case 3:
			// La columna tres contine la cantidad del producto, que es un entero
			return int.class;
		case 4:
			// La columna cuatro contine el vendedor asesor
			return String.class;
		default:
...
//		return (getValueAt(0, columnIndex).getClass());
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		Producto aux;
		aux = (Producto) (datos.get(rowIndex));
		// Cambia el campo del Item que indica columnIndex, poniendole el aValue que se nos pasa.
		switch (columnIndex) {
		case 0:
		...
		case 1:
			...
			break;
		case 2:
			aux.setItemPrice((String) aValue);
			break;
		case 3:
			aux.setQuantity((int) aValue); 
			break;
		case 4:
			aux.setVendedor((String) aValue);
			break;
		default:
			break;
		}
