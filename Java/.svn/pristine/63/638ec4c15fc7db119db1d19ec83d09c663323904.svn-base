package co.com.flamingo.transfer4690.util;
...
public class Util {
	...
	private static void initLogger() {
		try {
			...
			pro.load(Util.class.getResourceAsStream("/config/transfer46904j.properties"));
	...
	public static void loadProperties() {
		...
		try {
			properties.load(Util.class.getResourceAsStream("/config/transfer4690.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
