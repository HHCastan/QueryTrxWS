...
/**
 * <p>Clase Java para saveBrandResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="saveBrandResponse">
 *   &lt;complexContent>
...
@XmlType(name = "saveBrandResponse", propOrder = {
    "responseMessage"
})
public class SaveBrandResponse {
