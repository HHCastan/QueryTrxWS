...
public class KeyValue  extends com.fal.ws.impl.FalBaseDTO  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.ws.fal.com/", "keyValue"));
