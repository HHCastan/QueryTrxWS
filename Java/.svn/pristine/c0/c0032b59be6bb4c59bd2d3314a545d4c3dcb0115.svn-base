...
/**
 * <p>Clase Java para saveProductPriceResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="saveProductPriceResponse">
 *   &lt;complexContent>
...
@XmlType(name = "saveProductPriceResponse", propOrder = {
    "responseMessage"
})
public class SaveProductPriceResponse {
