...
/**
 * <p>Clase Java para deleteCurrencyRateResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteCurrencyRateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "deleteCurrencyRateResponse", propOrder = {
    "responseMessage"
})
public class DeleteCurrencyRateResponse {
