...
/**
 * <p>Clase Java para tillInteractionAnswer complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="tillInteractionAnswer">
 *   &lt;complexContent>
...
@XmlType(name = "tillInteractionAnswer", propOrder = {
    "answer",
    "id"
})
public class TillInteractionAnswer
    extends FalBaseDTO
{
